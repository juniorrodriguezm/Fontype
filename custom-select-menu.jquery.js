(function ($) {
  ...
  $.fn.customSelectMenu = function (options) {
    ...
    var settings = $.extend({
      ...
      /* The class name for the custom select menu div */
      openedClass: 'opened',
      /* The class given to the label when the menu is visible */
      selectedClass: 'selected',
      /* The class given to the list item when an option has been selected */
    ...
    function updateMenu(selection) {
      ...
      var customMenuName = selection.parent().attr('data-select-name'),
        ...
        customOptionValue = selection.attr('data-option-value'),
        /* Get the option value */
        customOptionText = selection.text(),
      ...
      var seleccion = document.querySelector(".selected").getAttribute('data-option-value');
      var pruebame = document.getElementById("pruebame");

      if (seleccion === "thin") {

        pruebame.style.fontFamily = "Buffon-Thin";

      }
      if (seleccion === "regular") {

        pruebame.style.fontFamily = "Buffon-Regular";

      }

      if (seleccion === "bold") {

        pruebame.style.fontFamily = "Buffon-Bold";

      }

      if (seleccion === "heavy") {

        pruebame.style.fontFamily = "Buffon-Heavy";
    ...
    return this.each(function () {
      ...
      var $this = $(this),
        ...
        /* Get the name of the original menu */
